...
function Footer(){
    return(
        ...
        <section className="cardFooter">
            ...
            <div className="footer-text"><a>Síguenos</a></div>
            ...
            <hr></hr>
                ...
                <div className="footerlist">
                    <li><Link to="/contactanos" className="links">Contáctanos</Link></li>
                    <li><Link to="/EnviosPedidosYDevoluciones" className="links">Pedidos, envíos y devoluciones</Link></li>
                </div>
            <br></br>
        </section>
        </>
